        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className=" md:space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <Button 
                size="lg"
                className="bg-[var(--color-secondary-500)] text-white hover:bg-[#c89410] hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl group"
              >
          ...
          <div className="relative h-[200px] md:h-[400px] lg:h-[600px] flex items-center justify-center">
            ...
            <div 
              className="absolute w-[300px] h-[257px] md:w-[300px] md:h-[343px] lg:w-[468px] lg:h-[401px] rounded-full overflow-hidden shadow-2xl z-10 animate-fade-up"
              style={{
